...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "St. Aldrin Public School" },
      {
        name: "description",
        content:
          "St. Aldrin Public School — CBSE affiliated co-educational school offering academics, sports and character education since 1974.",
      },
      { name: "author", content: "St. Aldrin Public School" },
